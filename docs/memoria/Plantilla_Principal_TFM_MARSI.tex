...
\newcommand{\authorNames}{Izan Viñes Castaño}
% Enlace al repositorio público del trabajo. Un solo sitio para cambiarlo.
\newcommand{\repolink}{\url{https://github.com/izanvines/TFM_ValveOperator}}
\newcommand{\pdftitle}{Aprendizaje por imitación en la apertura de válvulas con un humanoide Unitree G1: modelos visión-lenguaje-acción frente a políticas clásicas}
\hypersetup{
...
% Página con la DECLARACIÓN DE USO DE IA:
\input{capitulos/00_declaracion_ia}
...
\input{capitulos/02_estudio_problema}

\input{capitulos/03_gestion_proyecto}

\input{capitulos/04_solucion}

\input{capitulos/05_evaluacion}

\input{capitulos/06_conclusion}
...
\input{capitulos/A1_control_versiones}

\input{capitulos/A2_seguimiento}

\input{capitulos/A3_protocolo_evaluacion}

\input{capitulos/A4_gaussian_splatting}
